...
namespace CreditCardEligibilityCheckerAPI.Migrations
{
    ...
    [Migration("20200712122238_Audittablevalues")]
    partial class Audittablevalues
    {
            ...
            modelBuilder.Entity("CreditCardEligibilityCheckerAPI.Models.Audit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AnnualIncome = 30000,
                            CardId = "BAR",
                            CreatedDateTime = new DateTime(2020, 7, 12, 12, 22, 38, 106, DateTimeKind.Utc).AddTicks(9071),
                            DOB = "01-01-2010",
